...
if(isset($_POST["submit"])){
  ...
  $desc=$_POST["desc"];
    ...
    $q="INSERT INTO `sub-category`(cat_id,name,title,description,img) VALUES('$cat','$name','$title','$desc','$img')";
    mysqli_query($con,$q);
          ...
          <div class="col-md-9">
            <div class="card">
              ...
              <div class="card-body">
                    ...
                    <form id="form" action="sub-category-add.php" method="post" class="form-horizontal" enctype="multipart/form-data">
