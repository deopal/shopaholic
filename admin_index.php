        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="./pages/orders/orders.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <?php
                $q2="SELECT * FROM `contact_me` ";
                $res2=mysqli_query($con,$q2);
                $num2=mysqli_num_rows($res2);
                ?>
                <h3><?php echo $num2;?></h3>

                <p>User Message requests</p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
